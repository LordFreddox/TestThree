...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function sl(){return new bi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qa(),fragmentShader:`
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function ol(){return new bi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qa(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Af(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Rs?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Rc?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===$t&&(e="SHADOWMAP_TYPE_VSM"),e}function wf(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Qi:case $i:e="ENVMAP_TYPE_CUBE";break;case cn:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Rf(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case $i:e="ENVMAP_MODE_REFRACTION";break}return e}function Cf(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Is:e="ENVMAP_BLENDING_MULTIPLY";break;case eh:e="ENVMAP_BLENDING_MIX";break;case th:e="ENVMAP_BLENDING_ADD";break}return e}function Pf(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function Lf(n,e,t,i){const r=n.getContext(),a=t.defines;let s=t.vertexShader,o=t.fragmentShader;const l=Af(t),c=wf(t),h=Rf(t),u=Cf(t),d=Pf(t),m=vf(t),g=xf(a),_=r.createProgram();let f,p,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Zr).join(`
`)),s=Ka(s),s=Tl(s,t),s=Sl(s,t),o=Ka(o),o=Tl(o,t),o=Sl(o,t),s=bl(s),o=bl(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
